...
module SimpleCov
  module ResultMerger
    ...
    #     "specs-2-5": {
    #       "coverage": {
    #         "/builds/Av8zM41c/0/lg/identity-reporting-rails/lib/identity_config.rb": {
    #         ...
    #
    ...
    def self.fix_gitlab_paths
      Dir['coverage/**/.resultset.json'].each do |file|
        ...
        # ex: "/builds/Av8zM41c/0/lg/identity-reporting-rails/lib/identity_config.rb"
        path = json.dig(first_key, second_key).keys.first
        paths = path.split('identity-reporting-rails')
        # ex: "/builds/Av8zM41c/0/lg/"
        first_path = paths.first
        new_path = Dir.pwd.split('identity-reporting-rails').first
